...
@Data
public class ReporteDosExcelC2DTO {
	...
	public ReporteDosExcelC2DTO(ReporteDosC2DTO dto) {
		super();
	...
	public ReporteDosExcelC2DTO() {
		super();
	}

	
	public ReporteDosExcelC2DTO(String productodescripcion, String numerooperacion, String codigoreporte,
			...
			BigDecimal tasamonedanacional, BigDecimal tasamonedaextranjera, BigDecimal recibetasafijaspread, 
			BigDecimal pagatasafijaspread, BigDecimal importeusd) {
		super();
