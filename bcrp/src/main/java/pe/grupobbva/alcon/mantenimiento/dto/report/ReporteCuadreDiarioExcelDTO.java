...
@Data
public class ReporteCuadreDiarioExcelDTO {
	...
	public ReporteCuadreDiarioExcelDTO(String column1, String column2, String column3, String column4, String column5,
	...
	public ReporteCuadreDiarioExcelDTO() {
		super();
	}
	...
	public ReporteCuadreDiarioExcelDTO(ParametroResponse cuenta ) {
		//HEADERS
		super();
	...
	public ReporteCuadreDiarioExcelDTO(ParametroResponse estadoOperaciones , ImportesReporteCuadreDiario importes) {
		super();
	...
	public void sumatoriaimportesaldo(ImportesReporteCuadreDiario importes) {
	...
	public void diferencia(ReporteCuadreDiarioExcelDTO sumatotales, ReporteCuadreDiarioExcelDTO sumatoriaimportesaldo) {
	...
	public void diffinal(ReporteCuadreDiarioExcelDTO diferencia, ReporteCuadreDiarioExcelDTO otrasdivisas) {
	...
	public void sumatotales( ImportesReporteCuadreDiario importes) {
