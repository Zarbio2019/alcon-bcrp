...
public class ReporteSeisDTO {
	...
	public ReporteSeisDTO() {
		super();
	}

	public void updtReporteSeisDTO(ReporteSeisUpdateDeltaDTO dto) {
	...
	public ReporteSeisDTO(String id, String numerooperacion, String idCliente, String clientecodigo,
