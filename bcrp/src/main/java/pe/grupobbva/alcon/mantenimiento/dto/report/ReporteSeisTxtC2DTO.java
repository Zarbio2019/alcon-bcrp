...
public class ReporteSeisTxtC2DTO {
	...
	public List<String> headExcel(){
		List<String> columns = new ArrayList<String>();
		 ...
		 columns.add("Opción: Operación");		 
		 columns.add("Opción: Tipo");
		 columns.add("Opción: Ejercicio");
		 columns.add("Opción: Strike rate");
		 columns.add("Opción: Benchmark");
		 columns.add("Opción: Frecuencia del benchmark");
