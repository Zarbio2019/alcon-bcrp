...
@Data
public class ReporteUnoTxtC2DTO {
	...
	public ReporteUnoTxtC2DTO() {
		super();
	}

	public ReporteUnoTxtC2DTO(ReporteUnoC2DTO dto) {
		super();

		ReportUtils utils = new ReportUtils();

		this.codigoreporte = utils.completeSpace(dto.getCodigoreporte().replace("E", ""), 16);
		...
		this.fechatermino = dto.getFechavencimiento() != null ? utils.dateFormat(dto.getFechavencimiento()) : utils.completeZeros(null, 0, 8);
