...
//	private String frecuenciabenchmark;
//	private String montonominal;
//	private String iddivisa;
	

	public OperacionTasaDTO() {
		super();

	}

	public OperacionTasaDTO(String id, String idcarga, Calendar fechacontratacion, String idProducto,
			...
			String intermediariodescripcion, String estado, String estadodesc,String contrato, String residente, String estilo,
			String tipoopcion, String tipoproceso,String tipoprocesodesc, Integer historico, Calendar fechamovimiento, String usuariocarga,
...
//			String tipoaccion, BigDecimal strikerate, String benchmark, String frecuenciabenchmark) {
		super();
...
//		this.frecuenciabenchmark = frecuenciabenchmark;
	}
