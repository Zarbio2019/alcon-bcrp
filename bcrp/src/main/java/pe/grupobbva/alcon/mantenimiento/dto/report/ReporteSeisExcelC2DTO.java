...
@Data
public class ReporteSeisExcelC2DTO {
	...
	public ReporteSeisExcelC2DTO(ReporteSeisC2DTO dto) {
		super();
	...
	public ReporteSeisExcelC2DTO() {
		super();
	}

	public ReporteSeisExcelC2DTO(String productodescripcion, String numerooperacion, String codigoreporte,
			...
			BigDecimal importedivisasalida, BigDecimal tipocambiospot, String validacion, Calendar fechavencimiento, String tipoaccion, BigDecimal delta,
