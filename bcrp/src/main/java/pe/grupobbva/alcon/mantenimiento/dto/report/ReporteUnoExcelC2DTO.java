...
@Data
public class ReporteUnoExcelC2DTO {
	...
	public ReporteUnoExcelC2DTO(ReporteUnoC2DTO dto) {
		super();
	...
	public ReporteUnoExcelC2DTO() {
		super();
	}

	public ReporteUnoExcelC2DTO(String productodescripcion, String numerooperacion, String codigoreporte,
