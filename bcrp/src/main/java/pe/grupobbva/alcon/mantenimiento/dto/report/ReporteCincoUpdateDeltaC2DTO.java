...
@Data
public class ReporteCincoUpdateDeltaC2DTO {
	...
	public ReporteCincoUpdateDeltaC2DTO(String id, String numerooperacion, Calendar fechaproceso, BigDecimal deltas,
	...
	public ReporteCincoUpdateDeltaC2DTO() {
		super();
	}
}
