...
public class ReporteUnoDTO {
	...
	public ReporteUnoDTO() {
		super();
	}

	public ReporteUnoDTO(String id, String idcarga, Calendar fechacontratacion, String idProducto,
			String productodescripcion, String numerooperacion, String idCliente, String clientecodigo,
			String clientenombre, String sectorcliente, String clientepaisresidencia, String tipoentrega,
			String tipooperacion, String tipooperaciondescripcion, String iddivisaentrada,
			String divisaentradadescripcion, String iddivisasalida, String divisasalidadescripcion,
			BigDecimal importedivisaentrada, BigDecimal importedivisasalida, BigDecimal cotizacion,
			BigDecimal puntosswap, String basica, BigDecimal cambioref, Calendar fechavalor, Calendar fechavencimiento,
			Integer plazo, Calendar fechaejercicio, String callput, String plaza, String paisresidencia,
			String riesgopais, BigDecimal prima, String iddivisaprima, String divisaprimadescripcion,
			String observaciones, Calendar fechaalta, Calendar fechamodificacioncarga, String operacionsustituye,
			Calendar fechabaja, String nif, String intermediario, String intermediariodescripcion, String estado,
			String contrato, String residente, String estilo, String tipoopcion, String tipoproceso, Integer historico,
			Calendar fechamovimiento, String usuariocarga, String codigooperacion, BigDecimal importeusd,
			String codigoreporte, BigDecimal tasamonedanacional, BigDecimal tasamonedaextranjera, BigDecimal delta,
			BigDecimal montomonedaextranjera, String idmonedaextranjera, String monedaextranjeradescripcion,
			...
			String tipoclientedescripcion, BigDecimal tasadiferencial, Integer idfilaarchivo, Integer codigoestado) {
		super();
