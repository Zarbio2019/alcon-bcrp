...
@Data
public class ReporteSieteC2DTO {
	...
	public ReporteSieteC2DTO() {
		super();

	}

	public ReporteSieteC2DTO(String id, String idcarga, String idProducto, String productodescripcion,
			...
			Calendar fechatermino, String tipoentrega, BigDecimal preciopactado, BigDecimal commoditytamanocontratounid,
			...
			String tipoaccion, String observaciones, String tipoproceso, Calendar fechamovimiento,
