...
@Data
public class ReporteUnoExcelDTO {
	...
	public ReporteUnoExcelDTO(ReporteUnoDTO dto) {
		super();
	...
	public ReporteUnoExcelDTO() {
		super();
	}

	public ReporteUnoExcelDTO(String productodescripcion, String numerooperacion, String codigoreporte,
